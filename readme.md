...
- Boom, stone hit, puff, clapping, explosion, glass broken, whistling, sword sheath sound by Pixabay (https://pixabay.com/users/pixabay-1/) 
- Bell sound "Bell Sound Ring" by Mike Koenig (https://soundbible.com/26-Bell-Sound-Ring.html#)
- Wind sound "Wind Blow", Blood pull "Breeze Of Blood", Click sound "Reload" by UNIVERSFIELD (https://pixabay.com/users/universfield-28281460/) 
