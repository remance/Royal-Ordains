def call_reinforcement(self, team, call_type, character_index):
    ...
    if (self.team_commander[team] and self.team_commander[team].alive and
            ...
            call_pool[character_index] and call_pool[character_index][2] <= self.team_state[team]["supply_resource"]):
        ...
        self.team_state[team]["supply_resource"] -= call_pool[character_index][2]
