...
def create_sound_effect_pool(data_dir):
    sound_effect_pool = {}
    dir_path = os.path.join(data_dir, "sound", "effect")
    ...
    for file_name in sound_effect_pool:  # convert to tuple with pygame Sound object inside
