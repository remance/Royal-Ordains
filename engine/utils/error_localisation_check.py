...
def event_localisation_check(language):
    """Check for existence of both data and its localisation data for the input language"""
    ...
    for strategy in character_data.strategy_list:
        # if type(localisation.grab_text(("strategy", strategy, "Name"))) is tuple:
        print(localisation.grab_text(("strategy", strategy, "Name")))
    print("check character")
    for character in character_data.character_list:
        # if type(localisation.grab_text(("character", character, "Name"))) is tuple:
        print(localisation.grab_text(("character", character, "Name")))
