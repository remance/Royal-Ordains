...
class StageObject(sprite.Sprite):
    ...
    def __init__(self, sprite_id, pos, game_id=0, angle=0,
                 sprite_flip=0, animation_frame_play_time=0.1, width_scale=1, height_scale=1):
...
class RotateStageObject(StageObject):
    def __init__(self, sprite_id, pos, game_id=0, angle=0, sprite_flip=0, animation_frame_play_time=0.1, width_scale=1,
                 height_scale=1, rotate_speed=10, rotate_left=True):
        StageObject.__init__(self, sprite_id, pos, game_id, angle, sprite_flip, animation_frame_play_time, width_scale,
                             height_scale)
